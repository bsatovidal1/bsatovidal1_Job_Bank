...
namespace bsatovidal1_Job_Bank
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<JobbBankContext>(options =>
                options.UseSqlite(
                    Configuration.GetConnectionString("JobbBankContext")));

            //To give access to IHttpContextAccessor for Audit Data with IAuditable
            services.TryAddSingleton<IHttpContextAccessor, HttpContextAccessor>();

            services.AddDefaultIdentity<IdentityUser>(options => options
                .SignIn.RequireConfirmedAccount = false)//this handles the confirmation email, if the user confirms it, than they are autorized to login.
